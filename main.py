...
"""ProjectRoot
|-- main.py                         #calls convertSiteToBlocks.py, octree.py, block_inserter.py, block_info.py, passes filepath to park.parquet in call to convertSiteToBlocks module
|-- modules
|   |-- blocks.py                   #calls block_inserter.py, block_info.py, urbanforestparser.py            
|   +-- block_info.py               #reads branchPredictions - adjusted.csv, lerouxdata-long.csv
|   +-- block_inserter.py
|   +-- convertSiteToBlocks.py      #reads park.parquet when argument is called from main.py     
|   +-- octree.py
|   +-- urbanforestparser.py        #reads trees-park-site.csv
|   +-- glyphmapping.py
|-- data
    |-- branchPredictions - adjusted.csv
    +-- lerouxdata-long.csv
    +-- trees-park-site.csv
    +-- sites∂
        +-- park.parquet
